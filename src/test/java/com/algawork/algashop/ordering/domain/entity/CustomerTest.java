...
import com.algawork.algashop.ordering.domain.exception.CustomerArchivedException;
...
class CustomerTest {
    ...
    @Test
    void given_brandNewCustomer_whenAddLoyaltyPointsSumPoints() {
        Customer customer = new Customer(
                new CustomerId(),
                new FullName("John", "Doe"),
                new BirthDate(LocalDate.of(1991, 7, 5)),
    ...
    @Test
    void given_brandNewCustomer_whenInvalidLoyaltyPoints_shouldGenerateException() {
        Customer customer = new Customer(
                new CustomerId(),
                new FullName("John", "Doe"),
                new BirthDate(LocalDate.of(1991, 7, 5)),
