...
public class Order {
    ...
    private OffsetDateTime canceldAt;
    ...
    public Order(OrderId id, CustomerId customerId, Money totalAmount,
                 ...
                 OffsetDateTime canceldAt, OffsetDateTime readyAt, BillingInfo billing,
    ...
    public OffsetDateTime canceldAt() {
        return canceldAt;
    }
    ...
    private void setCanceldAt(OffsetDateTime canceldAt) {
